...
router.post('/login', validateRequest.body(authValidation.loginUser), AuthControllers.loginUser);

router.post('/logout', auth('USER'), validateRequest.body(authValidation.logoutUser), AuthControllers.logOutUser);

router.post('/register', validateRequest.body(authValidation.registerUser), AuthControllers.registerUser);
...
router.post(
    '/verify-reset-otp',
    validateRequest.body(authValidation.verifyPasswordResetOtpValidationSchema),
